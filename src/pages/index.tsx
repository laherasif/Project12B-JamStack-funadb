              ...
              /* and other goodies */
                ...
                <Form>
                  ...
                  <div className="modal-footer">
                    <button type="button" className="btn btn-danger" onClick={() => setmodal(false)}>Cencel</button>
            ...
            {({
               errors, touched }) => (
                ...
                <Form>
                  ...
                  <div className="modal-footer">
                    <button type="button" className="btn btn-danger" onClick={() => setedit(false)}>Cencel</button>
